...
namespace Data.Migrations
{
    ...
    [Migration("20220221162628_Create_ListedVehiclesModels")]
    partial class Create_ListedVehiclesModels
    {
            ...
            modelBuilder.Entity("Models.IntentsModels.Intent", b =>
                {
                    ...
                    b.Property<string>("VehicleOfIntentId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Models.ImagesModels.Image", b =>
                {
                    ...
                    b.HasOne("Models.VehiclesModels.Vehicle", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("Models.IntentsModels.Intent", b =>
                {
                    ...
                    b.HasOne("Models.VehiclesModels.Vehicle", "VehicleOfIntent")
                        .WithMany()
                        .HasForeignKey("VehicleOfIntentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
