...
public class RegisterAVehicleVm
{
    ...
    [Range(1960, int.MaxValue,ErrorMessage = "The year value has to be between 1960 and this year")]
    ...
    //List of All Models
    public List<Vehicles> VehiclesModels { get; set; } = new();
    public List<Makers> MakersList { get; set; } = new List<Makers>();
